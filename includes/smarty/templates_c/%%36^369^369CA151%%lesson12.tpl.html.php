<?php /* Smarty version 2.6.25-dev, created on 2015-09-28 20:01:27
         compiled from lesson12.tpl.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_radios', 'lesson12.tpl.html', 20, false),array('function', 'html_options', 'lesson12.tpl.html', 53, false),array('modifier', 'default', 'lesson12.tpl.html', 20, false),)), $this); ?>
<!DOCTYPE html>
<html lang="en">
    <head>
        <meta charset="utf-8">
    ...
    <body style="width:500px;padding: 30px;">
        ...
        <form class="form-horizontal" method="POST" role="form">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="seller_name" class="form-control" id="seller_name" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['ad_object']->seller_name)) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
" placeholder="Ваше имя">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="email" class="form-control" id="email" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['ad_object']->email)) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
" placeholder="Электронная почта">
                </div>
            </div>
            <div class="checkbox">
                <label>
                    <input type="checkbox" id="allow_mails" <?php echo $this->_tpl_vars['is_allow_mail']; ?>
> Я не хочу получать вопросы по объявлению по e-mail
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="phone" class="form-control" id="phone" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['ad_object']->phone)) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
...
">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="title" class="form-control" id="title" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['ad_object']->title)) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
" placeholder="Название" required></div></div>
            <div class="form-group">
                <label for="desc" class="col-sm-2 control-label">Описание</label>
                <div class="col-sm-10">
                    <textarea name="desc" id="desc" class="form-control" rows="3" required><?php echo ((is_array($_tmp=@$this->_tpl_vars['ad_object']->description)) ? $this->_run_mod_handler('default', true, $_tmp, '') : smarty_modifier_default($_tmp, '')); ?>
</textarea>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-10">
                    <input type="text" name="price" class="form-control" id="price" value="<?php echo ((is_array($_tmp=@$this->_tpl_vars['ad_object']->price)) ? $this->_run_mod_handler('default', true, $_tmp, 0) : smarty_modifier_default($_tmp, 0)); ?>
